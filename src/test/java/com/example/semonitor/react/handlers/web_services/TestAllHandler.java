...
public class TestAllHandler {
  ...
  void adds_successfully(Vertx vertx, VertxTestContext testContext) throws Throwable {
    ...
    mongoClient.insert("web_services", object, insertResult -> {
      ...
      webClient.get(Config.serverPort(),"localhost", "/api/webServices")
        ...
        .send( res -> {
          ...
          assertEquals(fields, res.result().bodyAsJsonArray().getJsonObject(0).fieldNames());
